<div class="col-md-4">
    ...
    <div class="or-seperator"><i>Se Connecter</i></div>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <button type="submit" name="login" class="btn btn-success btn-block login-btn">Se connecter</button>
        </div>
        <div class="clearfix">
            <label class="pull-left checkbox-inline"><input type="checkbox"> Se Souvenir de moi</label>
            <a href="#" class="pull-right text-success">Mot de pase oublié?</a>
        </div>  
        
    </form>
    <div class="hint-text small">Vous avez pas de compte? <a href="#" class="text-success">S'inscrire maintenant!</a></div>
</div>
 <?php 
            }
            else
          ...
          <div class="card-body">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button class="btn btn-secondary" name="search" type="submit">Aller!</button>
              </span>
            </div>
            </form>
          </div>
