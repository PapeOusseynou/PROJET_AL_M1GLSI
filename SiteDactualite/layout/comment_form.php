        ...
        <div class="card my-4">
          ...
          <div class="card-body">
            ...
            <form method="post" action="" onsubmit="myFunction()">
                ...
                <?php 
                 ...
                 <p class="lead">
                   <img src="admin/images/users/<?php echo $success_login_image_admin; ?>" class="zoom3" alt="User Image" width="50" align="left" hspace="5">
                      <a href="#"><?php echo $success_login_name_admin; ?></a> <br>Journaliste <a href="#">Galsen Actu</a>
              ...
              <button type="submit" name="save_comment" class="btn btn-primary">Soumettre</button>
            </form>
