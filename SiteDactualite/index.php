      ...
      <div class="col-md-8">
        ...
        <div class="card mb-4">
          ...
          <div class="card-footer text-muted">
            ...
            Par <a href="author.php?auth=<?= $view_users_id; ?>"><?php echo $view_users_name; ?></a> <br>Journaliste <a href="#">Galsen Actu</a>
        ...
        <ul class="pagination justify-content-center mb-4">
          <li class="page-item">
            <?php 
                ...
                ?>
            <a class="page-link" href="index.php?page=<?php echo $previous ?>">&larr; Precedent</a>
             <?php } ?>
          </li>
          <li class="page-item">
            <?php 
